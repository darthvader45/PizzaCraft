...
{
    public static final TagKey<Block> OVENS = TagKey.create(Registries.BLOCK, createResourceLocation("ovens"));
    ...
    //Forge
    public static final TagKey<Item> KNIVES = TagKey.create(Registries.ITEM, new ResourceLocation("forge", "tools/knives"));
